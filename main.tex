...
We know this because with $I=0.1,0.5$ the eigenvalues are complex conjugates, but the real part changes from negative to positive as we increase $I$ from $0.1$ to $0.5$. This suggests that the system undergoes a Hopf bifurcation at some critical value of $I$ between $0.1$ and $0.5$ where that real part of the eigenvalues crosses zero.
